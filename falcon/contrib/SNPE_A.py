...
class SNPE_A:
    def __init__(
        ...
        self.train_loss_batches = []   # List of training loss for each batch
        self.val_loss_batches = []     # List of validation loss for each batch
    ...
    async def train(self, dataloader_train, dataloader_val, hook_fn=None, dataset_manager=None):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch in dataloader_train:
                ...
                self.train_loss_batches.append(loss_train.item())
            ...
            for batch in dataloader_val:
                ...
                self.val_loss_batches.append(torch.mean(posterior_losses).item())
    ...
    def save(self, node_dir: Path):
        ...
        torch.save(self.train_loss_batches,      node_dir / "train_loss_batches.pth")
        torch.save(self.val_loss_batches,        node_dir / "val_loss_batches.pth")
        # epoch-wise
